...
- **Next steps:** Phase 6.6 (Python fine filter — scipy TCA refinement), then 6.7 (screener + /api/conjunctions). Full breakdown in `progress/week6_plan.md`. (6.0–6.5 done; C++ screening core + RTN transform complete.)
- **Tests:** 329 passing + 1 skipped (opt-in live fetch) across 7 test files — suite runs offline/deterministic. Frontend JS has no automated tests
